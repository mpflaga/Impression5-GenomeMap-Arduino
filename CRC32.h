...
class CRC32
{
  public:
    ...
    // set parameters
    void     setPolynome(uint32_t polynome) {
      _polynome = polynome;
    };
    void     setStartXOR(uint32_t start)    {
      _startMask = start;
    };
    void     setEndXOR(uint32_t end)        {
      _endMask = end;
    };
    void     setReverseIn(bool reverseIn)   {
      _reverseIn = reverseIn;
    };
    void     setReverseOut(bool reverseOut) {
